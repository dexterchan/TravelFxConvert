...
public class TestRemoteFxQuoteThread extends TestCase{
	...
	public void testApp() {
	    ...
	    ThreadPoolTaskExecutor taskExecutor = (ThreadPoolTaskExecutor) context.getBean("taskExecutor");
		 //ApplicationContext contextThread = new ClassPathXmlApplicationContext("SpringBeanConfig.xml");
		 
		 //ThreadPoolTaskExecutor taskExecutor = (ThreadPoolTaskExecutor) contextThread.getBean("taskExecutor");
